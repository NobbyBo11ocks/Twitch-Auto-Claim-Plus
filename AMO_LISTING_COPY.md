...
- The popup footer includes a plain link to the developer's Discord server, opened only if the user clicks it
- No credential collection
- Stores settings locally using browser extension storage
- Runs only on Twitch pages
